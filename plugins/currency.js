...
cmd({
    ...
    try {
        ...
        if (!rates[toCurrency]) {
            return reply("*❌ ɪɴᴠᴀʟɪᴅ ᴛᴀʀɢᴇᴛ ᴄᴜʀʀᴇɴᴄʏ ᴄᴏᴅᴇ! ᴘʟᴇᴀsᴇ ᴜsᴇ ᴠᴀʟɪᴅ ᴄᴜʀʀᴇɴᴄʏ ᴄᴏᴅᴇs ʟɪᴋᴇ ᴜsᴅ, ᴇᴜʀ, ᴢᴡ, ᴘᴜʟᴀ, ʀᴀɴᴅs ɢʙᴘ, ᴇᴛᴄ.*");
        }
        ...
        const message = `*🌍 ☘𝙉3𝙩𝙆𝙞𝙣𝙜 𝙈𝘿☘- ᴄᴜʀʀᴇɴᴄʏ ᴄᴏɴᴠᴇʀsɪᴏɴ 💵*\n\n` +
