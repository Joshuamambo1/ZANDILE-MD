...
cmd({
  ...
  try {
    ...
    if (!_0x3b2587 || !/^\d{10,15}$/.test(_0x3b2587)) {
      return _0x393f08("*❌ Invalid phone number format*.\n\nPlease enter a valid number with country code (.getpair 263780000000).");
    }
    await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
      'react': {
        'text': '⏳',
    ...
    if (_0x2e869c.code) {
      ...
      const _0xeea95a = "*⚡Pairing Code For 𝙺𝙴𝙴𝙽𝙻𝚈 𝚇𝙼𝙳 🗿*\n\n🪀 notification has been sent to your WhatsApp. Please check your phone and copy this code to pair it and get your *N 3 T K I N G ＭＤ* session id.\n\n*🔢 Pairing Code* : *" + _0x25f740 + "*\n\n> *_Copy it from below message 👇🏻_*";
      try {
        await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
          'image': {
            'url': "https://files.catbox.moe/cik12y.jpg"
          },
          'caption': _0xeea95a
        }, {
          'quoted': _0x2fe294
...
cmd({
  ...
  try {
    ...
    if (!_0x4de0bb) {
      return await _0x50e2bb("*Example -* .pair 263716729222");
    }
    ...
    await _0x50e2bb("> *N 3 T K I N G ＭＤ PAIR COMPLETED*\n\n*Your pairing code is:* " + _0x27dff2);
