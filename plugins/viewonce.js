...
const channelInfo = {
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            ...
            newsletterName: 'J̸͟͞o̸͟͞s̸͟͞h̸͟͞u̸͟͞a̸͟͞m̸͟͞a̸͟͞m̸͟͞b̸͟͞o̸͟͞1 T̸͟͞e̸͟͞c̸͟͞h̸͟͞ S̸͟͞u̸͟͞p̸͟͞p̸͟͞o̸͟͞r̸͟͞t̸͟͞D',
            serverMessageId: -1
        }
    }
};
    ...
    try {
        ...
        if (isViewOnceImage) {
            try {
                ...
                await sock.sendMessage(chatId, { 
                    image: buffer,
                    caption: `*💀 ☘𝙉3𝙩𝙆𝙞𝙣𝙜 𝙈𝘿☘ Anti ViewOnce 💀*\n\n*Type:* Image 📸\n${caption ? `*Caption:* ${caption}` : ''}`,
                    ...channelInfo
                });
        ...
        if (isViewOnceVideo) {
            try {
                ...
                await sock.sendMessage(chatId, { 
                    ...
                    caption: `*💀 JoshKingBot Anti ViewOnce 💀*\n\n*Type:* Video 📹\n${caption ? `*Caption:* ${caption}` : ''}`,
                    ...channelInfo
                });
